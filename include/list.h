...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/21 21:06:19 by tmuranak          #+#    #+#             */
/*   Updated: 2025/04/21 21:19:17 by tmuranak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_str_list	*str_list_search_node(\
	t_str_list *node, bool (*f)(char *, char *), char *str);

int			str_list_map_arg1(\
	t_str_list **node, char *(*f)(char *, void *), void *arg);
...
int			merge_sort(\
	t_void_list **node, bool (*cmp)(t_anytype, t_anytype));
